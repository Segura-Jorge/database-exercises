...
-- For example, to find all the unique titles within the company, we could run the following query:
	-- SELECT DISTINCT titile  FROM titiles;
...
-- when asked for the 10th page with a group of 5, i like to take the 10 and subtract 1 from it and then multiply them by the group number.
-- (P# - 1) * G# = PG
-- P = Page
-- G = Group
-- PG = Page Group